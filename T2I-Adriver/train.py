...
if __name__ == "__main__":
    ...
    try:
        ...
        # FIXME: the values are overwritten
        if not opt.coadapter2_finetune_from == "":
            load_pretrained_ckp(model, opt.coadapter2_finetune_from, "coadapter")
