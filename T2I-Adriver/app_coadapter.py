...
global_opt.config = 'T2I-Adriver/configs/stable-diffusion/sd-v1-inference.yaml'
...
coadapter_fuser.load_state_dict(torch.load(f'T2I-Adriver/models/coadapter-fuser-sd15v1.pth'))
